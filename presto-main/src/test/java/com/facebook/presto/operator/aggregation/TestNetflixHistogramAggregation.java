...
import static com.facebook.presto.operator.aggregation.TestApproximatePercentileAggregation.createRLEBlock;
        ...
        extends AbstractTestFunctions
{
    ...
    private static final InternalAggregationFunction NETFLIX_APPROXIMATE_PERCENTILE_AGGREGATION_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_APPROXIMATE_PERCENTILE_AGGREGATION_WITH_TYPE = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_APPROXIMATE_PERCENTILE_AGGREGATION_WITH_TYPE_COMPRESSION = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_APPROXIMATE_PERCENTILE_ARRAY_AGGREGATION_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_APPROXIMATE_PERCENTILE_ARRAY_AGGREGATION_WITH_TYPE = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_APPROXIMATE_PERCENTILE_ARRAY_AGGREGATION_WITH_TYPE_COMPRESSION = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    //weighted percentile
    private static final InternalAggregationFunction NETFLIX_APPROXIMATE_PERCENTILE_WEIGHTED_AGGREGATION_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_BUILD_SKETCH_STRING_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_BUILD_SKETCH_BINARY_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_COMBINE_SKETCH_STRINGS_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_COMBINE_SKETCH_BYTES_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    // query cdf functions
    private static final InternalAggregationFunction NETFLIX_QUERY_CDF_FROM_SKETCH_STRINGS_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_QUERY_CDF_ARRAY_FROM_SKETCH_STRINGS_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_QUERY_PERCENTILE_FROM_SKETCH_STRINGS_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_QUERY_PERCENTILE_ARRAY_FROM_SKETCH_STRINGS_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_QUERY_PERCENTILE_SKETCH_BYTES_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_QUERY_PERCENTILE_ARRAY_SKETCH_BYTES_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    private static final InternalAggregationFunction NETFLIX_QUERY_JSON_HISTOGRAM_SKETCH_STRINGS_WITH_DEFAULTS = metadata.getFunctionRegistry().getAggregateFunctionImplementation(
