        ...
        return Optional.of(new SystemTable()
        {
            ...
            public RecordCursor cursor(ConnectorTransactionHandle transactionHandle, ConnectorSession session, TupleDomain<Integer> constraint)
            {
                ...
                try {
                    ...
                    final com.netflix.iceberg.Table icebergTable = icebergUtil.getIcebergTable(icebergConfig.getMetacatCatalogName(), sourceTableHandle.getSchemaName(), sourceTableName.getTableName(), getConfiguration(session, sourceTableName.getSchemaName()));
